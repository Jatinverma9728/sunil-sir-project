...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
    ({
        ...
        const variants = {
            ...
            secondary: "bg-gradient-to-r from-[var(--secondary-pop)] to-[var(--secondary-warm)] text-white hover:shadow-[var(--glow-secondary)] hover:-translate-y-0.5 active:translate-y-0 focus-visible:ring-[var(--secondary-pop)]",
