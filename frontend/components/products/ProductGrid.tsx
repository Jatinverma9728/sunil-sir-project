                ...
                return (
                    <div
                        ...
                        className={`
                            ...
                            ${isHovered ? 'shadow-2xl shadow-gray-200/80 border-gray-200 -translate-y-2' : 'shadow-sm hover:shadow-lg'}
                        `}
                    >
                        {/* Product Image */}
                        <Link href={`/products/${product._id}`}>
                            <div className="relative bg-gradient-to-b from-gray-50 to-white h-64 flex items-center justify-center overflow-hidden m-4 rounded-2xl">
                                ...
                                {product.stock < 10 && product.stock > 0 && (
                                    <span className="absolute top-4 left-4 px-3 py-1.5 bg-orange-50 text-orange-600 text-xs font-semibold rounded-full">
                                        Only {product.stock} left
                                    </span>
                                )}
                                {product.stock === 0 && (
                                    <span className="absolute top-4 left-4 px-3 py-1.5 bg-red-50 text-red-600 text-xs font-semibold rounded-full">
                                        Out of Stock
                                    </span>
                                )}
                        ...
                        <div className="px-5 pb-6">
                            ...
                            <Link href={`/products/${product._id}`}>
                                <h3 className="font-semibold text-gray-900 mb-1 text-base line-clamp-2 min-h-[3rem] hover:text-gray-600 transition-colors">
                                    {product.title}
                                </h3>
                            </Link>
