...
function ProductsContent({ initialProducts = [], initialPagination = null }: ProductsClientProps) {
...
export default function ProductsClient({ initialProducts, initialPagination }: ProductsClientProps) {
    return (
        <Suspense fallback={
            ...
            <ProductsContent initialProducts={initialProducts} initialPagination={initialPagination} />
        </Suspense>
    );
}
